...
infile = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc"

infile_seasonmean = infile
outfile_seasonmean = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_30years_"+TS1+"_"+TS2+"_seasonmean_global.nc"
...
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_seasonmean)


infile_subdomain = infile
outfile_subdomain = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_yearmean_subdomain_global.nc" 
cdo.yearmean(input="/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/\
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_subdomain)
#to calculate time series for 100 years for the selected sub-domain

outfile_subdomain1 = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_30years_"+TS1+"_"+TS2+"_yearmean_subdomain_global.nc" 
cdo.yearmean(input="-seltimestep,"+TS1+"/"+TS2+" /HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/\
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_subdomain1)
...
outfile_subdomain_fldmean = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_yearmean_subdomain_fldmean_global.nc" 
cdo.fldmean(input="-yearmean /HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/\
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_subdomain_fldmean)
#to calculate grid-weighted average over the selected sub-domain 

############################
outfile_60_90N_fldmean = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_yearmean_subdomain_fldmean_60_90N.nc" 
...
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_60_90N_fldmean)
# to calculate mean weighted temperature for 60-90N 

############################# 
outfile_seasmean_DJF = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_30years_"+TS1+"_"+TS2+"_seasmean_DJF_global.nc" 
...
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_seasmean_DJF)


outfile_seasmean_MAM = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_30years_"+TS1+"_"+TS2+"_seasmean_MAM_global.nc" 
cdo.timselmean(3,2,9, input=" -seltimestep,"+TS1+"/"+TS2+" /HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/\
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_seasmean_MAM)

outfile_seasmean_JJA = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_30years_"+TS1+"_"+TS2+"_seasmean_JJA_global.nc" 
cdo.timselmean(3,5,9, input=" -seltimestep,"+TS1+"/"+TS2+" /HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/\
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_seasmean_JJA)

outfile_seasmean_SON = "/HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/rtmt_pert_30years_"+TS1+"_"+TS2+"_seasmean_SON_global.nc" 
cdo.timselmean(3,8,9, input=" -seltimestep,"+TS1+"/"+TS2+" /HOME/rrs/VF_2016/Simulations/CanESM4.1/model_output/pert_run/end/org_file/\
rtmt_Amon_DevAM4-1_piControl-end_r1i1p1_600101-610012.nc", output=outfile_seasmean_SON)
...
###############################################################################
fig=plt.figure(20011,figsize=(13,8))
fig.subplots_adjust(left=None,bottom=None,right=None,top=None,wspace=0.1,hspace=0.1)

ax = fig.add_subplot(221)
x, y = m_golbe(lon, lat)
my_cmap = matplotlib.cm.get_cmap('rainbow')
cax = m_golbe.pcolor(x,y,DJF,shading='flat',cmap=my_cmap,vmin=-100,vmax=100)
...
m_golbe.drawparallels(np.arange(30.,90.,20.))
m_golbe.drawmeridians(np.arange(-270.,271.,30.))
...
plt.text(0.90, 1.15,'Net Downward Flux (TOA)', horizontalalignment='left',verticalalignment='center', transform=ax2.transAxes,fontsize=25,color='k')
...
my_cmap = matplotlib.cm.get_cmap('rainbow')
cax = m_golbe.pcolor(x,y,MAM,shading='flat',cmap=my_cmap,vmin=-100,vmax=100)
...
my_cmap = matplotlib.cm.get_cmap('rainbow')
cax = m_golbe.pcolor(x,y,JJA,shading='flat',cmap=my_cmap,vmin=-100,vmax=100)
#cax = m.pcolor(x,y,T_MAM,shading='flat',cmap=my_cmap)
m_golbe.drawcoastlines(linewidth=0.5)
#m_golbe.drawcountries(linewidth=1.)
#m_golbe.drawstates(linewidth=1., linestyle='solid', color='k')
...
my_cmap = matplotlib.cm.get_cmap('rainbow')
cax = m_golbe.pcolor(x,y,SON,shading='flat',cmap=my_cmap,vmin=-100,vmax=100)
#cax = m.pcolor(x,y,T_MAM,shading='flat',cmap=my_cmap)
m_golbe.drawcoastlines(linewidth=0.5)
#m_golbe.drawcountries(linewidth=1.)
#m_golbe.drawstates(linewidth=1., linestyle='solid', color='k')
...
plt.savefig('Figure_801_rtmt_g',dpi=150)
...
fig=plt.figure(20021,figsize=(10,5))
plt.plot(YEAR, TS_subdom, linewidth=0.5, color='k',label='Downward flux (averaged over the sub-domain)')
...
ax = plt.gca()
plt.ylabel('Net downward flux at TOA [W/m$^{2}$]',fontsize=18, fontweight='normal')
...
plt.savefig('Figure_802_rtmt_g.png',dpi=150)


#####################################################################################


fig=plt.figure(20031,figsize=(12,10))
...
plt.text(0.0, 1.1,'a) Mean annual (Net downward flux at TOA)', horizontalalignment='left',verticalalignment='center', transform=ax2.transAxes,fontsize=20,color='k')

plt.savefig('Figure_803_rtmt_g.png',dpi=150)
###########################################################################
